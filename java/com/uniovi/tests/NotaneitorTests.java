...
public class NotaneitorTests {
	...
	public void PR07() { // Vamos al formulario de logueo.
		...
		PO_LoginView.fillForm(driver, "99999990D", "123456"); // COmprobamos que entramos en la pagina privada de Alumno
		PO_View.checkElement(driver, "text", "Notas del usuario");
	}
	...
	// PRN. Loguearse con exito desde el ROl de Alumno, 99999990D, 123456
	@Test
	...
	@Test
	public void PR13() { // Vamos al formulario de logueo.
		PO_HomeView.clickOption(driver, "login", "class", "btn btn-primary");
		// Rellenamos el formulario
	...
	public void PR15() { // Vamos al formulario de logueo.
		...
		elementos.get(0).click(); // Esperamos a que se muestren los enlaces de paginacion la lista de notas
		elementos = PO_View.checkElement(driver, "free", "//a[contains(@class, 'page-link')]");
		// Nos vamos a la última página
		elementos.get(3).click();
